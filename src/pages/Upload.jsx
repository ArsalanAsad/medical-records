      ...
      <div className="max-w-4xl">
        <div className="mb-6">
          ...
          <p className="text-slate-500 mt-2">
            Add a new medical report with details for future access and search.
          </p>
        </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              <label className="block mb-2 text-sm font-medium">Attach File</label>
              <input
                type="file"
                name="fileName"
                onChange={handleChange}
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 disabled:opacity-70 text-white px-6 py-3 rounded-lg transition"
          >
